...
const LAYER_ALIASES = new Map([
  ...
  ['windy cameras', 'windy-webcams'],
  ['ky-kytc-webcams', 'ky-kytc-webcams'],
  ['kytc', 'ky-kytc-webcams'],
  ['kytc cameras', 'ky-kytc-webcams'],
  ['kytc webcams', 'ky-kytc-webcams'],
  ['kentucky cameras', 'ky-kytc-webcams'],
  ['kentucky webcams', 'ky-kytc-webcams'],
  ['ca-cwwp-webcams', 'ca-cwwp-webcams'],
  ['caltrans', 'ca-cwwp-webcams'],
  ['caltrans cwwp', 'ca-cwwp-webcams'],
  ['caltrans cameras', 'ca-cwwp-webcams'],
  ['cwwp', 'ca-cwwp-webcams'],
  ['california cameras', 'ca-cwwp-webcams'],
  ['al-algo-webcams', 'al-algo-webcams'],
  ['algo', 'al-algo-webcams'],
  ['algo cameras', 'al-algo-webcams'],
  ['algo traffic', 'al-algo-webcams'],
  ['alabama cameras', 'al-algo-webcams'],
  ['alabama algo', 'al-algo-webcams'],
  ['webcam-explore', 'webcam-explore'],
  ['webcam explore', 'webcam-explore'],
  ['explore webcams', 'webcam-explore'],
  ['webcam explore cameras', 'webcam-explore'],
  ['nps-nature-cameras', 'nps-nature-cameras'],
  ['nps nature', 'nps-nature-cameras'],
  ['nps cameras', 'nps-nature-cameras'],
  ['nature cameras', 'nps-nature-cameras'],
  ['yellowstone cameras', 'nps-nature-cameras'],
  ['yellowstone webcams', 'nps-nature-cameras'],
